...
from action_visualization import colorize_action_scores
from make_story_image import format_action_shot, load_font, parse_prompt_scenes, resize_square, wrap_text
from sweep_utils import lambda_label, parse_action_gate_strengths
...
def _render_grid(prompt_file, prompt_parts, rows, title_suffix, output_path, provider, panel_size):
